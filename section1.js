...
const createAnimation = (position, scale) => {
  const sizes = [];
  const shift = [];
  const pushShift = () => {
    shift.push(
...
createAnimation(new THREE.Vector3(0, 0, 0), 1);
createAnimation(new THREE.Vector3(-10, 5, -10), 0.5);
createAnimation(new THREE.Vector3(10, -5, 10), 1.5);
